...
const healingPosts = [
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1522383225653-ed111181a951?auto=format&fit=crop&w=1080&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1517677208171-0bc6725a3e60?auto=format&fit=crop&w=1080&q=80',
  ...
  {
    id: 'redchestnut', categoryId: 'c1', feeling: '想要放下對所愛之人之擔憂 💕', flowerEssence: '紅栗樹',
    keyQuote: '我將擔憂化為滿滿的愛與祝福，送給最愛的人。',
    imageUrl: 'https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?auto=format&fit=crop&w=1080&q=80',
  ...
  // --- Category 2: 信任與指引 ---
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1515002246390-7bf7e8f87b54?auto=format&fit=crop&w=1080&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1490682143684-14369e18dce8?auto=format&fit=crop&w=1080&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?auto=format&fit=crop&w=1080&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?auto=format&fit=crop&w=1080&q=80',
  ...
  // --- Category 3: 擁抱當下 ---
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1542401886-65d6c61db217?auto=format&fit=crop&w=1080&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1462275646964-a0e3386b89fa?auto=format&fit=crop&w=1080&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1543431341-3b76cfb16e45?auto=format&fit=crop&w=1080&q=80',
  ...
  {
    id: 'olive', categoryId: 'c3', feeling: '想給自己一個深深的溫溫擁抱 🌿', flowerEssence: '橄欖',
    keyQuote: '我深深接納需要喘息的時刻，這本身就是一種完美。',
    imageUrl: 'https://images.unsplash.com/photo-1490730141103-6cac27aaab94?auto=format&fit=crop&w=1080&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1501430654243-c934cec2e1c0?auto=format&fit=crop&w=1080&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1597848212624-a19eb35e2651?auto=format&fit=crop&w=1080&q=80',
  ...
  // --- Category 4: 溫暖連結 ---
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1490750967868-8f514cae361f?auto=format&fit=crop&w=1080&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1520763185298-1b434c919102?auto=format&fit=crop&w=1080&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1527661591475-527312dd65f5?auto=format&fit=crop&w=1080&q=80',
  ...
  // --- Category 5: 安全與邊界 ---
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1463936575829-25148e1db1b8?auto=format&fit=crop&w=1080&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1507608616759-54f48f0af0ee?auto=format&fit=crop&w=1080&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1496857239036-1fb137683000?auto=format&fit=crop&w=1080&q=80',
  ...
  // --- Category 6: 希望與力量 ---
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1511875762315-c80ee915359a?auto=format&fit=crop&w=1080&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1524758631624-e2822e304c36?auto=format&fit=crop&w=1080&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1437482078695-73f5ca6c96e2?auto=format&fit=crop&w=1080&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1542273917363-3b1817f69a2d?auto=format&fit=crop&w=1080&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1473496169904-658ba7c44d8a?auto=format&fit=crop&w=1080&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1511920170033-f8396924c348?auto=format&fit=crop&w=1080&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?auto=format&fit=crop&w=1080&q=80',
...
export default function App() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      // 調整 Canvas 比例：1080x1200 (下方留白給主題文字)
      canvas.width = 1080;
      canvas.height = 1200;
      ...
      img.onload = () => {
        // 1. 繪製底圖 (Cover 模式，只佔用上方 1080x1080 的區域)
        const imageAreaHeight = 1080;
        const scale = Math.max(canvas.width / img.width, imageAreaHeight / img.height);
        ...
        ctx.fill();
        ctx.strokeStyle = 'rgba(254, 205, 211, 0.8)'; // rose-200 邊框
        ctx.lineWidth = 2;
        ctx.stroke();

        ctx.textAlign = 'center';
        ctx.textBaseline = 'middle';
        ctx.fillStyle = '#e11d48'; // rose-600 文字顏色
        ctx.fillText(essenceText, canvas.width / 2, badgeY + badgeHeight / 2);
        ctx.textBaseline = 'alphabetic'; // 恢復預設 baseline

        // 4. 繪製圖片上的情境文字 (位置微調以容納標籤)
        ctx.textAlign = 'center';
        ...
        // 7. 繪製「主題與識別文字」 (無 Logo 純文字置中)
        const footerText = '蜜絲P花研所-每日心靈療癒，用愛灌溉每一天';
        ctx.textAlign = 'center';
        ctx.fillStyle = '#78716c'; // stone-500 (淡灰色，呈現呵護感)
        ctx.font = '300 36px sans-serif'; // 細體字，優雅典雅
        const footerY = imageAreaHeight + (canvas.height - imageAreaHeight) / 2 + 12; // 垂直置中
            ...
            {selectedPost && (
              <div className="bg-white rounded-[2rem] overflow-hidden shadow-md border border-stone-100 max-w-lg mx-auto transition-all duration-500 transform sticky top-8">
                ...
                <div className="flex flex-col group">
                  ...
                  {/* 新增：下方白色主題區域 (你在程式碼生成的圖上會呈現這塊) */}
                  <div className="bg-white py-5 px-8 text-center border-b border-stone-100">
                    <p className="text-stone-500 font-light text-sm tracking-wider">
                      蜜絲P花研所-每日心靈療癒，用愛灌溉每一天
                    </p>
                  </div>
                </div>
